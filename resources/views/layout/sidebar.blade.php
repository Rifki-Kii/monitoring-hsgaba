<div id="sidebar" class="sidebar fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-gray-900 to-gray-800 flex flex-col border-r border-gray-700 shadow-2xl z-40">
    <div class="p-5 border-b border-gray-700 flex-shrink-0">
        <div class="flex items-center space-x-3">
            {{-- Pastikan asset logo benar --}}
            <img src="{{ asset('assets/logo-aba.png') }}" 
                 alt="Logo ABA" 
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden">
        <nav class="p-4 space-y-0.5">
            ...
            <a href="/dashboard"
                ...
                data-menu="dashboard">
                <div class="w-7 h-7 mr-2.5 rounded-md bg-gradient-to-r from-blue-500/20 to-blue-600/20 flex items-center justify-center group-hover:from-blue-500/30 group-hover:to-blue-600/30">
            ...
            <div class="sidebar-dropdown-group">
                <button class="sidebar-dropdown-btn w-full flex items-center justify-between p-2.5 rounded-lg transition-all duration-200 hover:bg-gray-800/50 group">
                    <div class="flex items-center">
                        <div class="w-7 h-7 mr-2.5 rounded-md bg-gradient-to-r from-emerald-500/20 to-emerald-600/20 flex items-center justify-center group-hover:from-emerald-500/30 group-hover:to-emerald-600/30">
                ...
                <div class="sidebar-submenu ml-9 mt-1 space-y-1 hidden">
                    <a href="/master/siswa" class="sidebar-submenu-item flex items-center p-2 rounded transition-all duration-200 hover:bg-gray-800/50" data-menu="siswa">
                    ...
                    <a href="/master/guru" class="sidebar-submenu-item flex items-center p-2 rounded transition-all duration-200 hover:bg-gray-800/50" data-menu="guru">
                    ...
                    <a href="/master/kelas" class="sidebar-submenu-item flex items-center p-2 rounded transition-all duration-200 hover:bg-gray-800/50" data-menu="kelas">
                        <i class="fas fa-school text-gray-400 text-xs mr-2.5"></i>
                        <span class="text-xs text-gray-300 hover:text-white">Data Kelas</span>
                    </a>
                    <a href="/master/mapel" class="sidebar-submenu-item flex items-center p-2 rounded transition-all duration-200 hover:bg-gray-800/50" data-menu="mapel">
            ...
            <div class="pt-1">
                ...
                <a href="/nilai" class="sidebar-menu-item group relative flex items-center p-2.5 rounded-lg transition-all duration-200 hover:bg-gray-800/50" data-menu="nilai">
                    <div class="w-7 h-7 mr-2.5 rounded-md bg-gradient-to-r from-purple-500/20 to-purple-600/20 flex items-center justify-center group-hover:from-purple-500/30 group-hover:to-purple-600/30">
                ...
                <a href="/poin" class="sidebar-menu-item group relative flex items-center p-2.5 rounded-lg transition-all duration-200 hover:bg-gray-800/50" data-menu="poin">
                    <div class="w-7 h-7 mr-2.5 rounded-md bg-gradient-to-r from-amber-500/20 to-amber-600/20 flex items-center justify-center group-hover:from-amber-500/30 group-hover:to-amber-600/30">
                ...
                <div class="sidebar-dropdown-group">
                    <button class="sidebar-dropdown-btn w-full flex items-center justify-between p-2.5 rounded-lg transition-all duration-200 hover:bg-gray-800/50 group">
                        <div class="flex items-center">
                            <div class="w-7 h-7 mr-2.5 rounded-md bg-gradient-to-r from-green-500/20 to-green-600/20 flex items-center justify-center group-hover:from-green-500/30 group-hover:to-green-600/30">
                    ...
                    <div class="sidebar-submenu ml-9 mt-1 space-y-1 hidden">
                        <a href="/statistik/akademik" class="sidebar-submenu-item flex items-center p-2 rounded transition-all duration-200 hover:bg-gray-800/50">
                        ...
                        <a href="/statistik/kedisiplinan" class="sidebar-submenu-item flex items-center p-2 rounded transition-all duration-200 hover:bg-gray-800/50">
                ...
                {{-- MENU LAPORAN (SUDAH DIUBAH JADI SINGLE LINK) --}}
                <a href="/laporan" 
                   class="sidebar-menu-item group relative flex items-center p-2.5 rounded-lg transition-all duration-200 hover:bg-gray-800/50"
                   data-menu="laporan">
                    <div class="w-7 h-7 mr-2.5 rounded-md bg-gradient-to-r from-red-500/20 to-red-600/20 flex items-center justify-center group-hover:from-red-500/30 group-hover:to-red-600/30">
            ...
            <div class="pt-1">
                ...
                <a href="/user"
                    class="sidebar-menu-item group relative flex items-center p-2.5 rounded-lg transition-all duration-200 hover:bg-gray-800/50"
                    data-menu="user">
                    <div class="w-7 h-7 mr-2.5 rounded-md bg-gradient-to-r from-indigo-500/20 to-indigo-600/20 flex items-center justify-center group-hover:from-indigo-500/30 group-hover:to-indigo-600/30">
                ...
                <a href="/tentang"
                    class="sidebar-menu-item group relative flex items-center p-2.5 rounded-lg transition-all duration-200 hover:bg-gray-800/50"
                    data-menu="tentang">
                    <div class="w-7 h-7 mr-2.5 rounded-md bg-gradient-to-r from-cyan-500/20 to-cyan-600/20 flex items-center justify-center group-hover:from-cyan-500/30 group-hover:to-cyan-600/30">
   ...
   <div class="p-4 border-t border-gray-700 bg-gray-900/50 flex-shrink-0">
    <div class="flex items-center space-x-2.5">
        ...
        <div class="relative">
            <div class="w-8 h-8 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center shadow">
                <span class="text-white text-sm font-bold uppercase">
                    {{ substr(auth()->user()->nama ?? 'U', 0, 1) }}
                </span>
            </div>
            <div class="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-green-500 border-2 border-gray-900" title="Online"></div>
        </div>
...
<style>
    ...
    .sidebar-menu-item.active { background: rgba(59, 130, 246, 0.12); border-left: 3px solid #3b82f6; }
    .sidebar-menu-item.active .text-gray-300 { color: white; font-weight: 500; }
    .sidebar-menu-item.active div { background: linear-gradient(to right, rgba(59, 130, 246, 0.25), rgba(59, 130, 246, 0.35)); }
    .sidebar-menu-item.active i { color: #60a5fa; }
    .sidebar-dropdown-btn.active { background: rgba(31, 41, 55, 0.6); }
    .sidebar-dropdown-btn.active i { transform: rotate(180deg); color: #9ca3af; }
    .sidebar-submenu { max-height: 0; overflow: hidden; transition: max-height 0.25s cubic-bezier(0.4, 0, 0.2, 1); }
    .sidebar-submenu.open { max-height: 180px; }
    .sidebar-submenu-item.active { background: rgba(59, 130, 246, 0.12); }
    .sidebar-submenu-item.active span { color: white; font-weight: 500; }
    .sidebar-submenu-item.active i { color: #60a5fa; }
    .sidebar-menu-item, .sidebar-submenu-item { transition: all 0.2s ease; }
    .sidebar::-webkit-scrollbar { width: 3px; }
    .sidebar::-webkit-scrollbar-track { background: rgba(31, 41, 55, 0.5); border-radius: 3px; }
    .sidebar::-webkit-scrollbar-thumb { background: rgba(75, 85, 99, 0.5); border-radius: 3px; }
    .sidebar::-webkit-scrollbar-thumb:hover { background: rgba(107, 114, 128, 0.7); }
